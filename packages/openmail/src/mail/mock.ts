...
export namespace MockData {
  ...
  export const folders: Mail.Folder[] = [
    ...
    { id: "STARRED", name: "Starred", type: "custom", unreadCount: 0 },
    { id: "SENT", name: "Sent", type: "sent", unreadCount: 0 },
    { id: "DRAFTS", name: "Drafts", type: "drafts", unreadCount: 1 },
    { id: "SPAM", name: "Spam", type: "spam", unreadCount: 0 },
  ...
  export const labels: Mail.Label[] = [
    { id: "work", name: "work", color: "#5c9cf5" },
    { id: "personal", name: "personal", color: "#7fd88f" },
    { id: "receipts", name: "receipts", color: "#f5a742" },
    { id: "newsletters", name: "newsletters", color: "#9d7cd8" },
  ]
